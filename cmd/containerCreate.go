...
var containerCreateCmd = &cobra.Command{
	Use:   "create",
	Short: "create a container in you storage account",
	Long:  `Here you can create a container in your storage account`,
...
func init() {
	...
	containerCreateCmd.Flags().StringVarP(&container, "container", "c", "", "a Azure Container (required)")
}
...
func createContainer(cmd *cobra.Command, args []string) error {
	...
	err = s.CreateContainer(container)
	return err
}
